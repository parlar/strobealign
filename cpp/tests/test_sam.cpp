...
TEST_CASE("Sam::add") {
    ...
    SUBCASE("Cigar =/X") {
        ...
        CHECK(sam_string ==
            "readname\t16\tcontig1\t3\t55\t2S2=1X3=3S\t*\t0\t0\tACGTT\tBB#>\tNM:i:3\tAS:i:9\tms:i:9\tde:f:0.5000\trl:i:5\ttp:A:P\tcm:i:0\ts1:i:0\ts2:i:0\tXp:i:0\tXW:f:1.00\tMD:Z:2G3\tnn:i:0\tXG:f:0.67\n"
        );
    }
    SUBCASE("Cigar M") {
        std::string sam_string;
        ...
        sam.add(aln, record, read_rc, 55, PRIMARY, details);
        CHECK(sam_string ==
            "readname\t16\tcontig1\t3\t55\t2S6M3S\t*\t0\t0\tACGTT\tBB#>\tNM:i:3\tAS:i:9\tms:i:9\tde:f:0.5000\trl:i:5\ttp:A:P\tcm:i:0\ts1:i:0\ts2:i:0\tXp:i:0\tXW:f:1.00\tMD:Z:2G3\tnn:i:0\tXG:f:0.67\n"
        );
    }
...
TEST_CASE("Pair with one unmapped SAM record") {
    ...
    CHECK(sam_string ==
      "readname\t89\tcontig1\t3\t55\t2=\t=\t3\t0\tGGTT\t<B!#\tNM:i:17\tAS:i:9\tms:i:9\tde:f:8.5000\trl:i:4\ttp:A:P\tcm:i:0\ts1:i:0\ts2:i:0\tXp:i:0\tXW:f:1.00\tMD:Z:2\tnn:i:0\tXG:f:0.50\n"
...
TEST_CASE("TLEN zero when reads map to different contigs") {
    ...
    // 129: PAIRED,READ2
    CHECK(sam_string ==
    "readname\t65\tcontig1\t3\t55\t2=\tcontig2\t4\t0\tAACC\t#!B<\tNM:i:17\tAS:i:9\tms:i:9\tde:f:8.5000\trl:i:4\ttp:A:P\tcm:i:0\ts1:i:0\ts2:i:0\tXp:i:0\tXW:f:1.00\tMD:Z:2\tnn:i:0\tXG:f:0.50\tMC:Z:3=\tMQ:i:57\n"
    "readname\t129\tcontig2\t4\t57\t3=\tcontig1\t3\t0\tGGTT\tIHB#\tNM:i:2\tAS:i:4\tms:i:4\tde:f:0.6667\trl:i:4\ttp:A:P\tcm:i:0\ts1:i:0\ts2:i:0\tXp:i:0\tXW:f:1.00\tMD:Z:3\tnn:i:0\tXG:f:0.00\tMC:Z:2=\tMQ:i:55\n"
    );
}
